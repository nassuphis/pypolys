...
def generate_roots(n_samples=100_000, seed=97531):
    ...
    for s, t in st_pairs:
        ...
        f6, g6 = (z**2 + w**2 + z*w - 1j*z + 1)**2, (w**3 + 1j*z**2 + z)**2
        f5, g5 = (z**3 + w*z - 1 + 1j*w)**2, (z**5 - w**2 + 1j)**2
        f4, g4 = (z**4 + w**4 + 1 + z)**2, (z**2 + w**2 - z*w + 1j)**2
        f3, g3 = (z + w + 1 + 1j*z*w)**2, (z**3 - w + z*w**2)**2
        f2, g2 = (z**2 - w + w**3 + 1j)**2, (z**4 + w*z - 1j)**2
        f0, g0 = (z**5 + w**2 + 2 + 1j*w)**2, (z**3 + 2*w + w**2)**2
...
if __name__ == "__main__":
    roots = generate_roots(n_samples=1_000_000)  # adjust this
    plot_roots(roots, dpi=1000, figsize=(10, 10), filename="wilkinson7_1.png")
