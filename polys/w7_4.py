...
def generate_roots(n_samples=100_000, seed=97531):
    ...
    for s, t in st_pairs:
        ...
        roots = np.roots(perturbed*t*s+coeffs*(1-t*s))
...
if __name__ == "__main__":
    roots = generate_roots(n_samples=100_000_000)  # adjust this
    plot_roots(roots, dpi=1000, figsize=(15, 15), filename="wilkinson7_4.png")
