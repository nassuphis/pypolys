...
import ops_basic as ops1         # basic stuff
import ops_poly  as ops2         # poly stuff
import ops_coeff as ops3         # moebius transforms
import argparse
import time
...
def _scan_worker(args):
    ( chain, wid, wcount, shm_roots_name, rows, cols, verbose ) = args
    if verbose:
    ...
    ALLOWED = ops1.ALLOWED | ops2.ALLOWED | ops3.ALLOWED  
    ORDER   = None  # or pass an explicit list; see below
